#
#  Be sure to run `pod spec lint BRPtouchPrinterKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.ios.vendored_frameworks = 'Frameworks/BRPtouchPrinterKitW.framework'
  ...
  s.frameworks = "SystemConfiguration", "CFNetwork", "UIKit", "Foundation", "CoreGraphics", "BRPtouchPrinterKitW"
